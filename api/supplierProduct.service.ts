...
import { ListSupplierProduct } from '../model/listSupplierProduct';
...
@Injectable()
export class NetFxSupplierProductService {
     ...
     */
    public Get(productId: string, options?: { observe?: 'body', reportProgress?: boolean}): Observable<SupplierProduct>;
    public Get(productId: string, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<SupplierProduct>>;
    public Get(productId: string, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<SupplierProduct>>;
    public Get(productId: string, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        ...
        return this.httpClient.get<SupplierProduct>(`${this.basePath}suppliers/products/${encodeURIComponent(String(productId))}`,
            {
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public List(options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'body', reportProgress?: boolean}): Observable<ListSupplierProduct>;
    public List(options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<ListSupplierProduct>>;
    public List(options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<ListSupplierProduct>>;
    public List(options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: any, reportProgress?: boolean}): Observable<any> {
        ...
        return this.httpClient.get<ListSupplierProduct>(`${this.basePath}suppliers/products`,
            {
