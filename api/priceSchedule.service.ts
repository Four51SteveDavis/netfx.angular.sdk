...
@Injectable()
export class NetFxPriceScheduleService {
     ...
     * 
     * 
     * @param pricescheduleId Priceschedule id of the price schedule.
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public Get(pricescheduleId: string, options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'body', reportProgress?: boolean}): Observable<PriceSchedule>;
    public Get(pricescheduleId: string, options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<PriceSchedule>>;
    public Get(pricescheduleId: string, options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<PriceSchedule>>;
    public Get(pricescheduleId: string, options?: { search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: any, reportProgress?: boolean}): Observable<any> {
		const opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public Post(priceSchedule: PriceSchedule, options?: { observe?: 'body', reportProgress?: boolean}): Observable<PriceSchedule>;
    public Post(priceSchedule: PriceSchedule, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<PriceSchedule>>;
    public Post(priceSchedule: PriceSchedule, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<PriceSchedule>>;
    public Post(priceSchedule: PriceSchedule, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
		const opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
        ...
        if (priceSchedule === null || priceSchedule === undefined) {
            throw new Error('Required parameter priceSchedule was null or undefined when calling post.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public Put(pricescheduleId: string, priceSchedule: PriceSchedule, options?: { observe?: 'body', reportProgress?: boolean}): Observable<PriceSchedule>;
    public Put(pricescheduleId: string, priceSchedule: PriceSchedule, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<PriceSchedule>>;
    public Put(pricescheduleId: string, priceSchedule: PriceSchedule, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<PriceSchedule>>;
    public Put(pricescheduleId: string, priceSchedule: PriceSchedule, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
		const opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
        ...
        if (pricescheduleId === null || pricescheduleId === undefined) {
            throw new Error('Required parameter pricescheduleId was null or undefined when calling put.');
        }
        if (priceSchedule === null || priceSchedule === undefined) {
            throw new Error('Required parameter priceSchedule was null or undefined when calling put.');
        }
